namespace OrderByDescending
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var methodSyntax = dataSource.Where(num => num > 20).OrderByDescending(num => num).ToList();
            ...
            var methodSyntax1 = dataSource1.Where(str => str.Length > 3).OrderByDescending(str => str).ToList();
            ...
            var methodSyntax2 = dataSource2.Where(emp => emp.Id > 2).OrderByDescending(emp => emp.Name).ToList();
        }
    }
}
